...
if (isset($_POST['pembayaran'])) {
    ...
    $query = mysqli_query($koneksi, "INSERT INTO pembayaran (id_petugas,tanggal_bayar,nisn,bulan_bayar,tahun_bayar,id_spp,jumlah_bayar) values('$id_petugas','$tanggal_bayar','$nisn','$bulan_bayar','$tahun_bayar','$id_spp','$jumlah_bayar')");
    if ($query) {
...
?>">
 ...
 <?php
            echo ($page == 'siswa' ||  $page == 'tambah-siswa' || $page == 'edit-siswa' || $page == 'hapus-siswa' ||  $page == 'kelas' || $page == 'tambah-kelas' ||  $page == 'edit-kelas' || $page == 'hapus-kelas' || $page == 'petugas' ||  $page == 'tambah-petugas' || $page == 'edit-petugas' || $page == 'hapus-petugas'  ? 'active' : '') ?>">
                ...
                <li class="nav-item
 <?php
            echo ($page == 'pembayaran' ||  $page == 'spp ' || $page == 'edit-spp' ||  $page == 'hapus-spp '  ||  $page == 'laporan ' ? 'active' : '') ?>">
                ...
                <form action="" method="post">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="tahun_bayar" class="form-control" required>
                        </div>
                        <div class="mb-3">
